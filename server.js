...
var message = process.env.MESSAGE || '这是一个K8s示例应用！';
...
var containerImage = process.env.CONTAINER_IMAGE || 'dogeek/hello-kubernetes:' + applicationVersion
...
logger.debug('从基本路径服务 "' + handlerPathPrefix + '"');
...
app.listen(port, function () {
  logger.info("侦听于: http://%s:%s", podName, port);
});